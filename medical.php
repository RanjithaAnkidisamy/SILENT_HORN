...
$connect = mysqli_connect("localhost", "root", "", "silenthorn");  
 ...
 {  
      ...
      $query = "INSERT INTO images(image,description) VALUES ('$file','$description')";  
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"><b>Upload Medical Records</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="medical.php" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="Decscription"></label>
            ...
            <div class="col-lg-12 mb-12">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h5 class="m-0 font-weight-bold text-primary"><b>File Upload<b></h5>
                </div>
                <div class="card-body">
                     ...
                     echo '  
                          <tr>  
							   ...
							   <td>
                                    ...
                                    <p style="color:#FF0000;">'.$row['description'].'</p>							 
							   </td>
                          </tr>  
                     ';  
                }  
